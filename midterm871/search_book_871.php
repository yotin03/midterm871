...
<br>
    ...
    $sql = "SELECT * FROM book_871 INNER JOIN classification_871 on book_871.class_id_871 = classification_871.class_id_871 WHERE book_id_871 LIKE '%$keyword%'";
